...
function getItems(){
    ...
    eventXmlHttp.open("POST", "getSaved.php", true); 
...
//https://codepen.io/Natarajah/pen/mAGQpw?editors=0110
function stupid(itemArr){
  ...
  let Item = React.createClass({
    ...
    render: function render() {
        ...
        React.createElement(
          'form',
          { action: 'removesaveditem.php', method: 'POST' },
          React.createElement(
            'input',{ type: 'submit', value: 'Remove Saved Item' }
          ),
          React.createElement(
